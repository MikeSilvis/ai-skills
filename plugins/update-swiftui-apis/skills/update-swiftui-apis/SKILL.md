...
Systematically scan Apple's developer documentation via the Sosumi MCP, identify deprecated SwiftUI APIs and their modern replacements, and update the SwiftUI Expert Skill's `latest-apis.md` reference.
...
- Prefer editing `~/Development/ai-skills/skills/swiftui-expert-skill/references/latest-apis.md`. If the repo checkout is unavailable, resolve the installed sibling skill at `../msilvis-swiftui-expert-skill/references/latest-apis.md`, but make the final change in the `ai-skills` repo so it can ship as a PR.

## Workflow

### 1. Understand current coverage

Read `~/Development/ai-skills/skills/swiftui-expert-skill/references/latest-apis.md` to understand:
